...
def eliminar_pedidos(pedidos):
    eliminar = int(input("Qual pedido deseja eliminar: "))
    if eliminar in pedidos:
        del pedidos[eliminar]
        print(f"Pedido {eliminar} foi eliminado")
...
def main():
    ...
    while True:
        ...
        print("5. eliminar  todos os pedidos")
        print("6. Sair")
